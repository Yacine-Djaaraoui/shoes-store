...
import LogoImg from "../../public/images/Group 138.png";
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
const Nav = () => {
  ...
  return (
    <header className="py-1 shadow">
      <div className=" mt-2 flex  container justify-between items-center ">
        <div className="logoImg lg:order-2">
          <img
            src={LogoImg}
            className="cursor-pointer object-contain h-[40px]"
            alt="#"
          />
        </div>
                    ...
                    {Navlinks.map((item) => (
                      ...
                      >
                        <button
                          ...
                          className="px-3 py-4 my-4 text-black font-semibold  hover:font-bold w-[100%]  lg:hover:text-black transition-all ease-in"
                        >
                          {item.label}
                        </button>
                        ...
                        <span className="ease absolute bottom-0 right-0 h-0 w-0 border-b-2 border-primary-color-100 transition-all duration-200 group-hover:w-full"></span>
